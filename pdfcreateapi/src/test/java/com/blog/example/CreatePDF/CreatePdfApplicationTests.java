...
public class CreatePdfApplicationTests {
	...
	@Test
	public void contextLoads() throws MessagingException, ParseException, DocumentException, IOException, InterruptedException {
		...
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create("http://localhost:8080/createpdf"))
